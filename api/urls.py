...
urlpatterns = [
	...
	path('post/<int:id>', PostView.PostDetailView.as_view({'get': 'retrieve'}), name='post'),
	...
	path('user/<str:username>/fav_posts', PostView.FavoritedPostsView.as_view({'get': 'list'}), name='posts_favorited_by'),
